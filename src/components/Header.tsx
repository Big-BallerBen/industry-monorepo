...
const Header: React.FC<HeaderProps> = ({ onOpenAi, onOpenActionDrawer, onOpenMenu }) => {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-40 px-6 py-4 grid grid-cols-3 items-center bg-panel/90 backdrop-blur-xl border-b border-glass-border transition-colors duration-300">
